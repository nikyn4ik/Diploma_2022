...
namespace Diploma_2022.Pages
{
    ...
    public partial class Package : Window
    {
        ...
        private void PDFOut(int ID_orders)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "SELECT orders.id_order,name_product,mark_package,type_model,date_package FROM orders INNER JOIN package ON orders.id_order = package.id_order where orders.id_order=@id";
            cmd.Parameters.AddWithValue("@id", ID_Orders);
            cmd.Connection = sqlConnection;
            sqlConnection.Open();
            ...
            while (dr.Read())
            {
                ...
                PdfWriter.GetInstance(doc1, new FileStream("PDF\\Накладная упаковка " + ID + ".pdf", FileMode.Create));
                doc1.Open();
                ...
                Chunk c11 = new Chunk(" " + "Тип упаковки:  " + dr[2], font);
                Chunk c12 = new Chunk(" " + "", font);
                Chunk c13 = new Chunk(" " + "Тип модели:  " + dr[3], font);
                Chunk c14 = new Chunk(" " + "", font);
                Chunk c15 = new Chunk(" " + "Дата упаковки:  " + dr[4], font);
                Chunk c16 = new Chunk(" " + "", font);
                Chunk c17 = new Chunk(" " + "", font);
                Chunk c18 = new Chunk(" " + "Заказ упакован Ф.И.О. (разборчиво)      __________________        __________________", font);
